...
$lang['email_address']      = 'Dirección email';
...
$lang['date_added']         = 'Fecha adición';
$lang['last_updated']       = 'Última subida';
...
$lang['newpassword_conf']   = '<b>Nueva Contraseña</b> (confirmar)';
$lang['chpassword']         = 'Cambiar Contraseña';
$lang['cur_password']       = 'Contraseña Actual';
...
$lang['click_here']         = 'Pulsa Aquí';
$lang['documentation']      = 'Documentación GamePanelX';
...
$lang['system_update']      = 'Una actualización del sistema está disponible!';
$lang['invalid_login']      = 'Acceso incorrecto!  Por favor inténtelo de nuevo.';
...
$lang['setup']              = 'Configurar';
$lang['settings']           = 'Ajustes';
$lang['game_setups']        = 'Configuración de Juegos';
...
$lang['add_reseller']       = 'Añadir Revendedor';
$lang['welcome_msg']        = 'Bienvenido a GamePanelX';
$lang['int_name']           = 'Nombre Interno';
$lang['int_name_desc']      = 'El nombre interno debe contener sólo letras, números y guiones bajos, por ejemplo "red_1"';
...
$lang['no_enc_key']         = 'No se encontró clave encriptada!  Comprueba "/configuration.php".';
...
$lang['add_ip']             = 'Añadir Dirección IP';
$lang['new_ip']             = 'Nueva Dirección IP';
$lang['ip_exists']          = 'Perdón, esta Dirección IP ya existe!';
$lang['ip_port_used']       = 'Perdón, esta combinación de IP/Puerto ya está en uso!';
$lang['srv_using_ip']       = 'Hay servidores de juegos usando esta dirección IP! Borre los servidores primero y pruebe nuevamente.';
$lang['invalid_ip']         = 'Dirección IP Inválida!  Por favor, compruebe e inténtelo otra vez.';

// Servers
$lang['create_sv']          = 'Crear Servidor';
$lang['invalid_port']       = 'Puerto inválido!  Por favor inténtelo de nuevo.';
$lang['invalid_intname']    = 'Nombre Interno inválido! Sólamente letras, números, - y _ son aceptados. Por favor inténtelo de nuevo.';
$lang['item']               = 'Artículo';
$lang['value']              = 'Valor';
...
// Cloud
$lang['cloud_avail']        = 'Juegos Disponibles vía <i>gpx cloud</i>';
$lang['cloud_topmsg']       = 'A medida que más juegos se añaden a la Nube de GamePanelX, ellos estarán disponibles aquí.';

// Games
$lang['games_add_desc']     = 'Usa este formulario para añadir nuevo soporte de juegos. Entonces podrás proceder con la creación de una plantilla para este juego.';
$lang['games_up_icon']      = '<b>Nota:</b> Sube tu icono PNG de 64x64';
$lang['note_steam_auto']    = '<b>Nota:</b> Para juegos Steam, deja la Ruta de Fichero vacía para usar el auto-instalador de Steam';
...
$lang['user_exists']        = 'Perdón, ese usuario ya existe!';

// Home Page hints
$lang['def_adm_step']       = 'Paso';
$lang['def_adm_tip_docs']   = 'Por favor, mira la documentación completa';
$lang['def_adm_tip_accts']  = 'Nada encontrado! Debes crear una cuenta de usuario para crear servidores.';
$lang['def_adm_tip_net']    = 'No se encontró Servidores de Red! Debes crear uno ahora.';
$lang['def_adm_tip_tpl']    = 'No se encontró plantillas completadas! Para crear servidores, debe escoger un juego y';
$lang['def_adm_tip_srv1']   = 'Ya estás preparado para crear un servidor!';
