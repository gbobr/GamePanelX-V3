...
if (isset($_REQUEST["password"]) == true) {
	$net2ftp_globals["password_encrypted"]  = encryptPassword(trim($_REQUEST["password"]));
	$_SESSION["net2ftp_password_encrypted_" . $net2ftp_globals["ftpserver"] . $net2ftp_globals["username"]] = encryptPassword(trim($_REQUEST["password"]));
